...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
		    ...
		    <h1>Powered by <a href="http://mobilegrows.com" rel="external">Mobilegrows.com</a> |<a href="http://www.fiducial.com/" rel="external">  Desktop Site</a></h1>
			  	...
			  	<div class="callbacks_container">
				    ...
				    <ul class="rslides" id="slider4">
				      ...
				      <li>
				        ...
				        <img src="img/slider-images/7slide.jpg" alt="Slider images">
				      ...
				      <li>
				        ...
				        <img src="img/slider-images/8slide.jpg" alt="Slider images">
				      ...
				      <li>
				        ...
				        <img src="img/slider-images/9slide.jpg" alt="Slider images">
				      ...
				      <li>
				        ...
				        <img src="img/slider-images/10slide.jpg" alt="Slider images">
				      ...
				      <li>
				        ...
				        <img src="img/slider-images/11slide.jpg" alt="Slider images">
				      ...
				      <li>
				        ...
				        <img src="img/slider-images/12slide.jpg" alt="Slider images">
				      ...
				      <li>
				        ...
				        <img src="img/slider-images/13slide.jpg" alt="Slider images">
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-b" id="findUS">
						...
						<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
							...
							<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Learning Center</a></div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					...
					<section id="navigation-menu">
						...
						<ul id="menu" class="menuhide">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Learning Center</a></li>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					...
					<section id="navigation-menu-contact">
							...
							<ul id="menu-contact" class="menuhide">
								...
								<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Learning Center</a></li>
